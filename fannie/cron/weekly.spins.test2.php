...
DEFINE('FTP_USER', 'est_lnsg');
DEFINE('FTP_PASS', 'etlsfc540');
...
error_log("[$timestamp] -- Week tag #$week selected.\n",3,$log_file);

//	Specify /path/to/file and filename
$outfile = $outpath . $prefix . "_" . $week . ".csv";
